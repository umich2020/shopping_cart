  ...
  return (
    <div id="homepages">
      ...
      <p>
        ...
        seafood for a gloriously starchy menu where every dish is a masterpiece
        of carbs—no protein allowed! The restaurant's decor is a charmingly
        chaotic fusion of wheat, potatoes, and pasta-themed furnishings. The
        booths are shaped like giant dinner rolls, the walls are covered in
        spaghetti murals, and the menu? Oh, it's a dream come true for carb
        enthusiasts:
      </p>
      </div>
      ...
      <img onClick={redirect} className="socials" src={TikTok} alt="TikTok logo" />
      </div>
    </div>
  );
}
